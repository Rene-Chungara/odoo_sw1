{
    "name": "Gestión Académico",
    "version": "1.0",
    "summary": "Módulo académico y calendario academico",
    "description": "Este módulo permite gestionar estudiantes, cursos y profesores y mostrar calendario con notificaciones.",
    "author": "Grupo 14 Sw",
    "category": "Education",
    ...
    "data": [
        ...
        "views/calendario_views.xml",
        "views/acciones_views.xml",
        "menu/ga_menu.xml",
