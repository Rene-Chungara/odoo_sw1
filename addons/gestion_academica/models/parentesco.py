...
class Parentesco(models.Model):
    ...
    apoderado_id = fields.Many2one('gestion_academica.apoderado', string='Tutor', required=True, ondelete='cascade')
    ...
    nombre_apoderado = fields.Char(related='apoderado_id.name', string='Nombre Tutor', store=True)
